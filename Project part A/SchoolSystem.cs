...
namespace Project_part_A
{
    public class SchoolSystem
    {
        ...
        public void MainMenu()
        {
            try
            {
                Console.WriteLine("Виберіть опцію: 1 - Додати учня, 2 - Додати вчителя, 3 - Додати предмет, 4 - Додати клас\n" +
                    "5 - Вибирання студентом предмета, 6 - Додавання студенту до класу, 7 - Вчитель обирає предмет, 8 - Лабораторна робота");
